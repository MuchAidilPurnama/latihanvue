...
<div class="basis-1/4 hover:basis-1/2 m-2" >
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Adidas Superstar</h5>
        </a>
...
<div class="basis-1/4 hover:basis-1/2 m-2">
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Adidas Forum XLG</h5>
        </a>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Silahkan lihat detailnya dengan menekan tombol order.</p>
        <br>
        <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
<div class="basis-1/4 hover:basis-1/2 m-2">
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Adidas Samba</h5>
        </a>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Silahkan lihat detailnya dengan menekan tombol order.</p>
        <br>
        <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
